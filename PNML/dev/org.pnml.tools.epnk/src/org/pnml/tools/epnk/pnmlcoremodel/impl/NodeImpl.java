 ...
 *   <li>{@link org.pnml.tools.epnk.pnmlcoremodel.impl.NodeImpl#getEtiq <em>Etiq</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class NodeImpl extends ObjectImpl implements Node {
	...
	/**
	 * The cached setting delegate for the '{@link #getEtiq() <em>Etiq</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getEtiq()
	 * @generated
	 * @ordered
	 */
	protected EStructuralFeature.Internal.SettingDelegate ETIQ__ESETTING_DELEGATE = ((EStructuralFeature.Internal)PnmlcoremodelPackage.Literals.NODE__ETIQ).getSettingDelegate();
	...
	public String getEtiq() {
		return (String)ETIQ__ESETTING_DELEGATE.dynamicGet(this, null, 0, true, false);
	}
	 ...
	 */
	@Override
	public void setEtiq(String newEtiq) {
		ETIQ__ESETTING_DELEGATE.dynamicSet(this, null, 0, newEtiq);
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case PnmlcoremodelPackage.NODE__IN:
				return getIn();
			case PnmlcoremodelPackage.NODE__ETIQ:
				return getEtiq();
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case PnmlcoremodelPackage.NODE__IN:
				...
				return;
			case PnmlcoremodelPackage.NODE__ETIQ:
				ETIQ__ESETTING_DELEGATE.dynamicUnset(this, null, 0);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case PnmlcoremodelPackage.NODE__ETIQ:
				return ETIQ__ESETTING_DELEGATE.dynamicIsSet(this, null, 0);
		}
