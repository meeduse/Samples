 ...
 *   <li>{@link org.pnml.tools.epnk.pnmlcoremodel.impl.LabelImpl#getId <em>Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class LabelImpl extends EObjectImpl implements Label {
	 ...
	 * @ordered
	 */
	protected EStructuralFeature.Internal.SettingDelegate ID__ESETTING_DELEGATE = ((EStructuralFeature.Internal)PnmlcoremodelPackage.Literals.LABEL__ID).getSettingDelegate();
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case PnmlcoremodelPackage.LABEL__UNKNOWN:
				return getUnknown();
			case PnmlcoremodelPackage.LABEL__ID:
				return getId();
		}
