...
public class PnmlcoremodelPackageImpl extends EPackageImpl implements PnmlcoremodelPackage {
	...
	public static PnmlcoremodelPackage init() {
		...
		Object registeredPnmlcoremodelPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		PnmlcoremodelPackageImpl thePnmlcoremodelPackage = registeredPnmlcoremodelPackage instanceof PnmlcoremodelPackageImpl ? (PnmlcoremodelPackageImpl)registeredPnmlcoremodelPackage : new PnmlcoremodelPackageImpl();
	 ...
	 */
	@Override
	public EAttribute getNode_Etiq() {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getNode_Etiq(), ecorePackage.getEString(), "etiq", null, 1, 1, Node.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		...
		initEAttribute(getArc_Etiq(), ecorePackage.getEString(), "etiq", null, 1, 1, Arc.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		...
		initEAttribute(getLabel_Id(), ecorePackage.getEString(), "id", null, 0, 1, Label.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		...
		initEAttribute(getLine_Width(), ecorePackage.getEFloat(), "width", "1.0", 1, 1, Line.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$ //$NON-NLS-2$
		...
		initEAttribute(getCoordinate_X(), ecorePackage.getEFloat(), "x", "0.0", 1, 1, Coordinate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$ //$NON-NLS-2$
		initEAttribute(getCoordinate_Y(), ecorePackage.getEFloat(), "y", "0.0", 1, 1, Coordinate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$ //$NON-NLS-2$
		...
		initEAttribute(getFont_Rotation(), ecorePackage.getEFloat(), "rotation", null, 1, 1, Font.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		...
		addAnnotation
		  (this,
		   ...
		   new String[] {
			   ...
			   "ptnet", "http://org.pnml.tools/epnk/types/ptnet" //$NON-NLS-1$ //$NON-NLS-2$
		   });
	}
	...
	protected void createMeeduseAnnotations() {
		...
		addAnnotation
		  (getNode_Out(),
		   ...
		   new String[] {
			   "generated", "OK", //$NON-NLS-1$ //$NON-NLS-2$
			   "association", "out" //$NON-NLS-1$ //$NON-NLS-2$
		   });
		addAnnotation
		  (getNode_In(),
		   source,
		   new String[] {
			   "generated", "OK", //$NON-NLS-1$ //$NON-NLS-2$
			   "association", "in" //$NON-NLS-1$ //$NON-NLS-2$
		   });
		addAnnotation
		  (getNode_Etiq(),
		   source,
		...
		addAnnotation
		  (getArc_Source(),
		   ...
		   new String[] {
			   "generated", "OK", //$NON-NLS-1$ //$NON-NLS-2$
			   "association", "source" //$NON-NLS-1$ //$NON-NLS-2$
		   });
		addAnnotation
		  (getArc_Target(),
		   source,
		   new String[] {
			   "generated", "OK", //$NON-NLS-1$ //$NON-NLS-2$
			   "association", "target" //$NON-NLS-1$ //$NON-NLS-2$
		   });
		addAnnotation
		  (getArc_Etiq(),
		   source,
		...
		addAnnotation
		  (getNodeGraphics_Position(),
		   source,
		   new String[] {
			   "generated", "NOT" //$NON-NLS-1$ //$NON-NLS-2$
		   });
		addAnnotation
		  (getNodeGraphics_Dimension(),
		   source,
		   new String[] {
			   "generated", "NOT" //$NON-NLS-1$ //$NON-NLS-2$
		   });
		addAnnotation
		  (getNodeGraphics_Line(),
		   source,
		   new String[] {
			   "generated", "NOT" //$NON-NLS-1$ //$NON-NLS-2$
		   });
		addAnnotation
		  (getNodeGraphics_Fill(),
		   source,
		   new String[] {
			   "generated", "NOT" //$NON-NLS-1$ //$NON-NLS-2$
		   });
		addAnnotation
		  (annotationGraphicsEClass,
		   source,
		   new String[] {
			   "generated", "NOT" //$NON-NLS-1$ //$NON-NLS-2$
		   });
		addAnnotation
		  (getAnnotationGraphics_Fill(),
		   source,
		   new String[] {
			   "generated", "NOT" //$NON-NLS-1$ //$NON-NLS-2$
		   });
		addAnnotation
		  (getAnnotationGraphics_Line(),
		   source,
		   new String[] {
			   "generated", "NOT" //$NON-NLS-1$ //$NON-NLS-2$
		   });
		addAnnotation
		  (getAnnotationGraphics_Offset(),
		   source,
		   new String[] {
			   "generated", "NOT" //$NON-NLS-1$ //$NON-NLS-2$
		   });
		addAnnotation
		  (getAnnotationGraphics_Font(),
		   source,
		   new String[] {
			   "generated", "NOT" //$NON-NLS-1$ //$NON-NLS-2$
		   });
		...
		addAnnotation
		  (getFill_GradientColor(),
		   source,
		   new String[] {
			   "generated", "NOT" //$NON-NLS-1$ //$NON-NLS-2$
		   });
		addAnnotation
		  (getFill_Gradientrotation(),
		   source,
		   new String[] {
			   "generated", "NOT" //$NON-NLS-1$ //$NON-NLS-2$
		   });
