...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Spot Location</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link extractedMM.impl.SpotLocationImpl#getAssociatedNetElements <em>Associated Net Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SpotLocationImpl extends BaseLocationImpl implements SpotLocation {
	/**
	...
	protected EClass eStaticClass() {
		return ExtractedMMPackage.Literals.SPOT_LOCATION;
	}
	...
	public EList<AssociatedNetElement> getAssociatedNetElements() {
		if (associatedNetElements == null) {
			associatedNetElements = new EObjectContainmentEList<AssociatedNetElement>(AssociatedNetElement.class, this,
					ExtractedMMPackage.SPOT_LOCATION__ASSOCIATED_NET_ELEMENTS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case ExtractedMMPackage.SPOT_LOCATION__ASSOCIATED_NET_ELEMENTS:
