 ...
 * </p>
 * <ul>
 *   <li>{@link extractedMM.impl.AreaLocationImpl#getAssociatedNetElements <em>Associated Net Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AreaLocationImpl extends BaseLocationImpl implements AreaLocation {
	/**
	...
	protected EClass eStaticClass() {
		return ExtractedMMPackage.Literals.AREA_LOCATION;
	}
	...
	public EList<AssociatedNetElement> getAssociatedNetElements() {
		if (associatedNetElements == null) {
			associatedNetElements = new EObjectContainmentEList<AssociatedNetElement>(AssociatedNetElement.class, this,
					ExtractedMMPackage.AREA_LOCATION__ASSOCIATED_NET_ELEMENTS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case ExtractedMMPackage.AREA_LOCATION__ASSOCIATED_NET_ELEMENTS:
