...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Route Body Property</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link extractedMM.impl.RouteBodyPropertyImpl#getAppliesToRouteBody <em>Applies To Route Body</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class RouteBodyPropertyImpl extends ConfiguredBaseObjectImpl implements RouteBodyProperty {
	/**
	 ...
	 * @generated
	 */
	protected RouteBodyPropertyImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ExtractedMMPackage.Literals.ROUTE_BODY_PROPERTY;
	}
			...
			if (appliesToRouteBody != oldAppliesToRouteBody) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ExtractedMMPackage.ROUTE_BODY_PROPERTY__APPLIES_TO_ROUTE_BODY, oldAppliesToRouteBody,
							appliesToRouteBody));
			}
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ExtractedMMPackage.ROUTE_BODY_PROPERTY__APPLIES_TO_ROUTE_BODY:
			if (resolve)
